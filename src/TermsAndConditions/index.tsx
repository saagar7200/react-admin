      ...
      <div  className="termsWrapper">
        ...
        <div className="contentWrapper">
          ...
          <p className="terms_content contentColor">
            ...
            <strong>“We”, “Us”, “Rayy” or “Our”</strong> where such
            ...
            <strong>“Terms and Conditions” or “Agreement”</strong>) carefully as
            they contain the legal terms and conditions that you agree to when
            you use the service provided by us through the Website and the App (
        ...
        <div className="contentWrapper">
          ...
          <p className="terms_content contentColor">
            ...
            submit certain requested information to Rayy. During
            registration we display our current Terms and Conditions for your
            perusal.
          </p>
          <p className="terms_content contentColor">
            ...
            Rayy. If the member does not comply with this then it would
        ...
        <div className="contentWrapper">
          ...
          <p className="terms_content contentColor">
            ...
            successful (constituting a “<strong>Qualifying Transaction</strong>
            “). Members can share these customized Rayy links with their
            friends, family and so on. When any Qualifying Transactions are
            generated through these links and Rayy receives commission fee
            for these Qualifying Transactions from Retailers, Rayy will pay
            ...
            not get paid commission from Retailers for Qualifying Transactions,
            then no Profit is due to the Member as well.
          </p>
          <p className="terms_content contentColor">
        ...
        <div className="contentWrapper">
          ...
          <p className="terms_content contentColor">
            ...
            Platform, You must be 18 (eighteen) years of age or older; and (ii)
            by visiting the Platform or accepting these Terms and Conditions,
            You represent and warrant to Rayy that You are 18 (eighteen)
            years of age or older, and that You have the right, authority and
            capacity to use the Platform and agree to and abide by these Terms
            and Conditions; provided however that if You are a parent or legal
            guardian of a person younger than 18 (eighteen) years of age, You
            are permitted to access and use the Platform for the purposes of
            procuring the Services, on behalf of such persons. You must register
            for the Service using accurate and current information about
            yourself – including your correct name, address and any other
            requested details. If you are asked for, and provide, details of a
            bank account or Cheque payment details or other payment mode details
            into which you wish to receive payments (your “
            <strong>Profit Receipt Method</strong>“), you (a) must ensure that
            you are, and remain, fully entitled to use that profit Receipt
            Method, and (b) confirm that you wish to receive profit through that
            Profit Receipt Method. You should keep this information updated
            through your Account. Please note that Profit payments by Cheque
            carry an additional fee of Rs 30 to cover for administrative costs.
          </p>
          <p className="terms_content contentColor">
            Generation, collection and dissemination of ‘Sensitive Personal Data
            or Information’ is in accordance with Information Technology Act,
            2000 as amended from time to time and allied rules requires the
            User’s express consent.. By affirming assent to this Policy by
            ...
            retailer partners for the purpose of their risk analysis and any
            other statutory requirements. By clicking on the “
            <strong>I agree with Terms and Policy</strong>” button you allow us
            to share your data and information with the retailer partner.
          </p>
          <p className="terms_content contentColor">
          ...
          <p className="terms_content contentColor">
            ...
            we hold for you is kept up-to-date and that you have full access to
            it – we will be sending you important messages there. If you change
            email address or mobile number, then you must change the details we
            hold for you on your Account.
          </p>
        </div>
        <div className="contentWrapper">
          ...
          <p className="terms_content contentColor">
            ...
            Transaction, or Profit may not result from it. This is also true for
            a Qualifying Referral. The Member understands that all transactions
            made by him/her are not with us, but with the individual Retailer.
            Our help pages provide further information about these
            circumstances. Further, from time to time Retailers may increase or
            decrease the commission paid – in which case the profit offer
            illustrated on our Platform may be incorrect. By default, your
            applicable transactions will be credited in line with the commission
            reported to us by the Retailer, which may be more or less than the
          ...
          <p className="terms_content contentColor">
            ...
            the Retailer confirms the transaction, the payment will be marked as
            ‘validated’ – this can take 90 days or more from the date of the
            purchase. If the goods are returned or the sale reversed or amended
            by any means then the Profit payment will not be made. Apart from
            the Retailer, it is also mandatory for the members to intimate
            Rayy about any returns or exchanges for which they might have
            earned Profit unduly.
          </p>
          <p className="terms_content contentColor">
            ...
            understands and agrees to the same. We shall not be held responsible
            if the Retailer fails to report a sale to us or does not qualify a
            transaction as Qualifying Transaction. Further, we shall not be
            responsible in the event due to some technical or other error we
            cannot trace a sale back to the Member and does not qualify the
            transaction as a Qualifying Transaction or a Qualifying Referral for
            any reason whatsoever. Whilst we will endeavour to recuperate
            non-payments from the Retailer, the decision of ourselves, the
            Retailer or Retailer’s tracking agent is final. Whilst we will try
            and recuperate missing commissions, at any point we reserve the
            right not to chase missing commission claims, particularly where no
          ...
          <p className="terms_content contentColor">
            ...
            which are already marked as payable or validated in your Account, or
            for transactions which have already been paid over to you by NEFT,
            Cheque, Gift Cards or any other payment modes as We may introduce
            from time to time. In all such incidences, Rayy has the right to
            recover all unduly paid profit which the member is not entitled to
            earn, through legal proceedings.
          </p>
        </div>
        <div className="contentWrapper">
          ...
          <p className="terms_content contentColor">
            You can withdraw your validated profit when you have at least INR 10
            in your Account. In the event the Member decides to close the
            ...
            will be forfeited. If the validated Profit in your account is Rs 250
            or above, then you can request payment of the same via any of the
            Profit Receipt Methods. Profit payments by Cheque carry an
            additional fee of Rs 30. This is charged by our Bank to cover
            administration and postage costs. We have the discretion to forfeit
            any such validated balance showing on your Account for the reasons
            provided elsewhere in this Agreement.
          </p>
        </div>
        <div className="contentWrapper">
          <p className="contentHead contentColor">7. Intellectual Property:</p>
          ...
          <ol type="a">
            <li>
              ...
              which we or our sub-licensee make the Service (or a service based
              on our service) available; and
            </li>
            <li>
              to other Members (through us, under the license referred to in a.
              above), the non-exclusive, personal, non-transferable right to
              view the relevant material.
            </li>
          </ol>
        </div>
        <div className="contentWrapper">
          ...
          <p className="terms_content contentColor">
            Pouring Pounds Limited and/ or Pouring Pounds India Private Limited
            (as the case may be) ({" "}
            <strong>We”, “Our”, “Rayy” or “Us”,</strong> where such
            expression shall unless repugnant to the context thereof, be deemed
            to include its respective legal heirs, representatives,
            ...
            below), Rayy is required to collect and use certain information
            ...
            explains how We collect, use, share and protect personal information
            of the Users of the Services (jointly and severally referred to as{" "}
            <strong>“You”, “Your”, “Yourself”</strong> or “User” or “Users” in
            this Privacy Policy). We have created this Privacy Policy to ensure
            our steady commitment to the privacy of the information of the Users
            who interact with our Services. Your use of and access to the
            Services is subject to this Privacy Policy and our Terms and
            Conditions. Any capitalized term used, but not defined, in this
            Privacy Policy shall have the meaning attributed to it in our Terms
            and Conditions.
          </p>
          <p className="terms_content contentColor">
          ...
          <ol type="a">
            <li>
              ...
              Personal Data or Information) Rules, 2011 to mean any information
            ...
            <li>
              ...
              (https://rayy.com/) and Mobile Application (Rayy) and
              contextual information transmitted to/ received from Users via
              various communication channels including but not limited to
              e-mail, SMS, WhatsApp, phone calls, website chat, IVR. We are
              primarily engaged in the business of allowing Users to share
              customized links for various products in the network of such
              Users, the customized links drive sales to e-commerce websites and
              in turn the Users earn cashbacks. We currently operate under the
              brand name Rayy.
            </li>
            <li>
            ...
            <li>
              ...
              <Link to="https://earnkaro.com/">https://rayy.com/</Link>, the{" "}
              <strong>“Application”</strong> and/ or <strong>“App”</strong>{" "}
              shall refer to the Rayy mobile application available on
              Android Play Store or iOS App Store. These shall be collectively
          ...
          <ol type="a">
            <li>
              ...
              agreement between the User and Rayy, and that the User shall
              be subject to the rules, guidelines, policies, terms, and
            ...
            <li>
              ...
              is published in accordance with the provisions of the SPI Rules
              and Intermediaries Guidelines.
            </li>
            <li>
              The terms ‘Party’ and ‘Parties’ shall respectively be used to
              refer to the User and Rayy individually and collectively, as
            ...
            <li>
              ...
              without any prior permission or intimation to the User keeping in
              mind best practices and laws set by State/Central Government of
              India, and the User expressly agrees that any such amendments or
              modifications shall come into effect immediately. The User has a
              duty to periodically check the Policy and Terms and Conditions and
              stay updated on their provisions and requirements. If the User
              continues to use the Services following such a change, the User
              will be deemed to have consented to any and all amendments/
              modifications made to the Policy and Terms and Conditions. In so
              far as the User complies with the Policy and Terms and Conditions,
          ...
          <ol type="a">
            ...
            <li>
              Your bank account information including name of the bank account,
              account number, IFSC code, bank branch or any other payment
              related information
            </li>
            <li>
              Any other information that you voluntarily choose to provide to us
              (such as information shared by you with us through emails, calls
              or letters, your work details, home / work address, your family
              details, details about transactions done on ecommerce sites,
              screenshots of transactions, order IDs for transactions, alternate
              numbers and emails and various other information provided from
              time to time).
            </li>
          </ol>
          <p className="terms_content contentColor">
          ...
          <ol type="a">
            <li>
              ...
              law will not be considered as ‘Personal Information’ or ‘Sensitive
              Personal Data or Information’ for the purposes of this Policy.That
              Rayy may automatically track information about the User based
              on the User’s IP address and the User’s behaviour on the Platform,
              and the User expressly consents to the same. The User is aware
              that this information may be used to conduct internal research on
              user demographics, interests, and behaviour, to enable Rayy to
              better understand, and cater to the interests of the Users.
              Further, the User is expressly made aware that such information
              may include the User’s computer &amp; web browser information, the
              User’s IP address, mobile device details etc. The linkage between
              User’s IP address and User’s personally identifiable information
              may be shared with or disclosed to third parties in order to
              facilitate the provisions of the Services to You. The User hereby
              consents to the sharing of such information to such third parties
              as may be determined by Rayy from time to time. Further, we
              may also share and/or disclose some of the aggregate findings (not
              the specific data) in anonymized form (i.e., non-personally
              identifiable) with third parties for market research and new
              feature development.
            </li>
            <li>
              That any and all information pertaining to the User collected by
              Rayy, whether or not directly provided by the User to
              Rayy, including but not limited to personal correspondence
              such as emails or letters or SMS or WhatsApp or calls, feedback
              from other users or third parties regarding the User’s activities
              or postings on the Platform, etc., may be collected and compiled
              by Rayy into a file/folder specifically created for/allotted
              to the User, and the User hereby expressly consents to the
              same.Also, in order to keep You informed of Your activities on the
              Website we occasionally send You emails, SMS, App notifications
              and other marketing communication. These include Your transaction
              messages to show how much You have earned, referral messages that
              show You how much You have earned from referrals, payment
            ...
            <li>
              ...
              to receiving the same. The User may choose to unsubscribe from
              ...
              emailing us on support@rayy.com
            </li>
            <li>
              That Rayy may occasionally request the User to complete
              ...
              services that Rayy believes they might be interested in
              availing of.
            </li>
            <li>
              ...
              aware that such reviews will help potential users of the Platform
              in availing the Services, and the User hereby expressly authorizes
              Rayy to publish any and all reviews written by the User on the
              Platform, along with the User’s name and certain contact details,
              for the benefit and use of other users.
            </li>
            <li>
              ...
              by the User, without cause or being required to notify the User of
              the same.
            </li>
            <li>
              Generation and collection of ‘Sensitive Personal Data or
              Information’ in accordance with Information Technology Act, 2000
              as amended from time to time and allied rules requires the User’s
            ...
            <li>
              ...
              email on support@rayy.com. Rayy will make good faith
              efforts to make requested changes in the databases as soon as
              reasonably practicable. If the User provides any information that
              is untrue, inaccurate, out of date or incomplete (or becomes
              untrue, inaccurate, out of date or incomplete), or Rayy has
              reasonable grounds to suspect that the information provided by the
              User is untrue, inaccurate, out of date or incomplete, Rayy
            ...
            <li>
              ...
              withdraw his/ her/ its consent at any time, in accordance with the
              terms of this Privacy Policy, and the Terms and Conditions
              applicable to such User, it being however clarified that
              withdrawal of consent will not be retroactive. If the User wishes
              to delete his/her account or request that Rayy no longer uses
              the User’s information to provide Services, the User may contact
              Rayy on support@rayy.com. We shall not retain such
              ...
              cancellation of account may result in Pouring Pounds being unable
              to provide you with its Services or to terminate any existing
          ...
          <p className="terms_content contentColor">
            All the information provided to Rayy by a User, including
          ...
          <p className="terms_content contentColor">
            ...
            and/ or other information that a User provides to Us. In the event
            of a merger or acquisition, We shall notify You by email/by putting
            a notice on the Website and/ or Application before Your Personal
          ...
          <p className="terms_content contentColor">
            Rayy may need to disclose/ transfer User’s Personal Information
          ...
          <ol type="a">
            <li>
              ...
              <ol>
                ...
                <li>
                  to protect and defend the rights or property of Rayy;
                </li>
          ...
          <p className="terms_content contentColor">
            ...
            maintained by Us in an electronic form on our equipments, and on the
            equipments of our employees. Such information may also be converted
          ...
          <p className="terms_content contentColor">
            ...
            have been collected by Us. Rayy may, therefore, retain and
            submit all such records to the relevant stakeholders.
          </p>
          <p className="terms_content contentColor">
            ...
            access by members inside and outside Rayy. We follow generally
          ...
          <p className="terms_content contentColor">
            ...
            also make use of any privacy settings or controls We provide you in
            Our Platform.
          </p>
          <p className="terms_content contentColor">
          ...
          <p className="terms_content contentColor">
            8.7.7. Notwithstanding the above, Rayy is not responsible for
            the confidentiality, security or distribution of your Personal
            Information by third parties outside the scope of our agreement with
            such third parties. Further, Rayy shall not be responsible for
            any breach of security or for any actions of any third parties or
            events that are beyond the reasonable control of Rayy including
          ...
          <p className="terms_content contentColor">
            ...
            and request a physical or electronic copy of information held about
            you. You also have the right to request information on the source of
            your Personal Information/Sensitive Personal Information.
          </p>
          <p className="terms_content contentColor">
          ...
          <p className="terms_content contentColor">
            When You avail our Services on the Platform, a persistent cookie is
          ...
          <p className="terms_content contentColor">
            ...
            to earn cashback / point when You shop from our website.
          </p>
          <p className="terms_content contentColor">
          ...
          <p className="terms_content contentColor">
            Rayy, an affiliate platform, is essentially a service provider that
            connects retailers and publishers. Rayy is not liable to pay for
            any commission which is cancelled by the partner retailer due to any
            reason whatsoever and not limited to bulk buying, self consumption,
            unattributed sale, return or cancellation of product and/or
            violating any affiliate policy of our partner retailer. Users are
            required to constantly keep a check on profit rates and terms of
            campaigns as these are subject to change real time without prior
            notice. Rayy reserves the right to cancel the profit as directed
            by the partner retailer. By signing up on Rayy, user agrees to
          ...
          <p className="terms_content contentColor">
            ...
            way Rayy treats User Information, or in the Privacy Policy
            itself, Rayy will display a notice on the Website or send Users
            an email, as provided for above, so that the User may review the
            changed terms prior to continuing to use the Services. As always, if
            the User objects to any of the changes to our terms, and the User no
          ...
          <p className="terms_content contentColor">
            ...
            Rayy’s information collection, use and disclosure practices, You
            may contact, the Data Protection Officer appointed by Rayy. We
        ...
        <div className="contentWrapper">
          ...
          <ol type="a">
            ...
            <li>
              whether the Retailer can or will supply and pass good title to any
              goods or services.
            </li>
          </ol>
          <p className="terms_content contentColor">
            Members should exercise no lesser degree of caution in entering into
            transactions with Retailers than they would when entering into a
            similar transaction offline. To the extent that the Applicable Law
            permits, you release us, our agents and employees from all liability
            arising out of or in connection with any transactions with
            Retailers, including (without limitation) all claims and demands
            relating to uncompleted or completed transactions with Retailers, or
        ...
        <div className="contentWrapper">
          ...
          <p className="terms_content contentColor">
            ...
            personal information of someone else, or a payment method which they
            are not entitled to use, (b) by deceptively or unfairly exploiting a
            Retailers’ offering including but not limited to creating fake or
            unauthorized referral links, or (c) in breach of any terms and
            conditions applied by us or the Retailer to that transaction. We
            reserve the right to forfeit any pending payments or validated
            payments in the Member’s Account in case of such misuse of our
          ...
          <ol type="a">
            ...
            <li>
              where it constitutes feedback on a Retailer, is accurate and fair;
              and
            </li>
          ...
          <p className="terms_content contentColor">
            ...
            discretion of the Retailer or us, has committed fraud in use of the
            Platform or our Service or misused the Platform or the Service,
            their Account will be closed, email and IP address will be
            blacklisted so they cannot use it again and cannot register from the
            same PC.
          </p>
          <p className="terms_content contentColor">
        ...
        <div className="contentWrapper">
          ...
          <p className="terms_content contentColor">
            For security or other reasons, we may require you to change password
            or other information which facilitates access to the Service;
            however, we will never ask you for your password via email,
        ...
        <div className="contentWrapper">
          ...
          <ol>
            <li>
              By applying to Rayy Amazon Affiliate Program, the User is
              guided and expected to abide by a separate{" "}
            ...
            <li>
              This is a moderated program and only eligible users (as decided by
              Rayy and/or Amazon) will be allowed to function.
            </li>
            <li>
        ...
        <div className="contentWrapper">
          ...
          <p className="terms_content contentColor">
            ...
            except as provided in sub-section 13(d). In particular, but not as a
            limitation thereof, we and our affiliated parties are not liable for
            any indirect, special, incidental or consequential damages
            (including damages for loss of business, loss of profits, savings,
            ...
            fundamental elements of the basis of the agreement between us and
            you. This Platform and the products, services, documents, content
            and materials and information presented would not be provided
            without such limitations. No advice or information, whether oral or
            written, obtained by you from us through the Platform or otherwise
          ...
          <ol type="a">
            <li>
              We warrant that the Service will be provided with reasonable care
              and skill with the intention of meeting our specifications for the
              Service, but we cannot and do not guarantee that the Service will
            ...
            <li>
              ...
              subcontractors. The aggregate liability of Rayy and the
              affiliated parties in connection with any claim arising out of or
              relating to the Platform and/or the products, information,
              documents and services provided herein or hereby shall not exceed
              Rs 500 and that amount shall be in lieu of all other remedies
            ...
            <li>
              ...
              <ol type="i">
                <li>
                  ...
                  profits; (B)any errors in or omissions from the Platform or
                  any services or products obtainable therefrom; (C) the
                  unavailability or interruption of the Platform or any features
                  thereof; (D) your use of the Platform; (E) the content and
                  materials contained on the Platform; (F) or any delay or
                  failure in performance beyond our control or any of our
                  affiliated parties.
                </li>
                <li>
                  for any indirect, special or consequential loss damage, costs
                  or other claims, howsoever caused or arising, whether through
                  non-supply or late supply of the Service or other
        ...
        <div className="contentWrapper">
          ...
          <p className="terms_content contentColor">
          You hereby expressly agree to receive communications by way of SMS, e-mails, mobile app and browser notifications, and any other messages from time to time from Rayy relating to Services provided through the Website
          </p>
        ...
        <div className="contentWrapper">
          ...
          <p className="terms_content contentColor">
          This Agreement is intended to contain your entire agreement with us relating to the Service; we believe it to be fair and reasonable. It replaces all earlier agreements and understandings with you relating to the Service, except for any fraud or fraudulent representation by either of u
          </p>
        ...
        <div className="contentWrapper">
         ...
         <ol type="a">
         <li>commencing no less than three days after the date of posting (or such later date as we indicate in the relevant posting), if any of the changes is to an operative provision of this Agreement which is capable of adversely affecting you; if you do not wish to be governed by the new version of the Agreement, you may notify us on or before the date when the new version of the Agreement is to take effect, and from that date you must cease to use our service or</li><li>immediately upon the date of posting (or such later date as we indicate in the relevant posting), if the changes are not to operative provisions, or not capable of adversely affecting you – examples of which would include, without limitation, changes to contact details referred to, or the refinement of provisions that are already included, in this Agreement.</li>
         </ol>
        </div>{" "}
        <div className="contentWrapper">
          <p className="contentHead contentColor">
        ...
        <div className="contentWrapper">
          ...
          <p className="terms_content contentColor">
          We don’t separately file the individual Agreements entered into by Members when they register for the Service. You can access it at www.rayy.com. Please make a durable copy of this Agreement by printing and/or saving a downloaded copy on your own computer. It is offered in English only.
          </p>
